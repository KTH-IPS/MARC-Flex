...
SKELETON_FOLDER = "/home/ips-gpu-server/tianyuwang/har-dataset/MARC-Flex/clipped_video/scenario_d/assembly/video_clips/clips_skeleton/"
...
output_folder = os.path.dirname(SKELETON_FOLDER) + '_merged_normalized/'
if not os.path.exists(output_folder):
    os.mkdir(output_folder)

# merge_single_video(input_path, output_path)
merge_multiple_video(SKELETON_FOLDER, output_folder, fhd=True)
