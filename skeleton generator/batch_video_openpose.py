...
"""
This generator is used for process multiple videos in a folder and multiple videos for one each label, by openpose, from video to skeleton
"""

openpose_path = "/home/zhihaoliu/openpose160/openpose-1.6.0"
input_folder = '/home/zhihaoliu/ml_data/zhihao_video/debug2/'
...
dirname = os.path.dirname(input_folder) + '_skeleton/'
